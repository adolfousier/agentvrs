...
pub struct MaterialLib {
    ...
    pub table_green: Handle<StandardMaterial>,
    pub table_white: Handle<StandardMaterial>,
...
pub fn setup_materials(mut commands: Commands, mut mats: ResMut<Assets<StandardMaterial>>) {
    let lib = MaterialLib {
        ...
        table_green: mat(&mut mats, 0.10, 0.45, 0.20),
        table_white: mat(&mut mats, 0.95, 0.95, 0.95),
        ...
        door_frame: mat(&mut mats, 0.60, 0.45, 0.25),
