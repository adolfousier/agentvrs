...
mod bevy_tests {
    ...
    fn test_update_skips_when_closed() {
        ...
        app.insert_resource(MissionControlState { open: false, selected_agent: None, popup_open: false });
    ...
    fn test_update_creates_agent_cards_when_open() {
        ...
        app.insert_resource(bridge);
        app.insert_resource(MissionControlState { open: true, selected_agent: None, popup_open: false });
        app.insert_resource(test_theme());
        app.add_systems(Startup, setup_mission_control);
        app.add_systems(Update, update_mission_control);
        app.update(); // startup
